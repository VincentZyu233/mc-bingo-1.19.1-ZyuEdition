execute as @e[tag=line] at @s if block ~ ~-1 ~-1 air run setblock ~ ~-2 ~ minecraft:yellow_concrete
...
execute as @e[tag=line] at @s unless block ~ ~-1 ~-1 air run setblock ~ ~-1 ~ minecraft:yellow_concrete
